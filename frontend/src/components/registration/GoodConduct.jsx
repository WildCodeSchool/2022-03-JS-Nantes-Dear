        ...
        <div className="conduct-title-first">
          ...
          <CheckboxGroup onChange={setOnChange}>
            <div className="checking">
              <label htmlFor="box">
                <Checkbox name="tos" />
                <input className="box" id="box" type="hidden" />
                La Divulgation d’informations personnelles.
              </label>
              <label htmlFor="box">
                <Checkbox name="tos" />
                <input className="box" ref={ref} id="box" type="hidden" />
                Le harcèlement moral, les menaces, les discours haineux, la
                diffamation ayant pour but d’intimider ou de porter atteintes
                aux membres de la communauté.
              </label>
              <label htmlFor="box">
                <Checkbox name="tos" />
                <input className="box" ref={ref} id="box" type="hidden" />
                La discrimination. Tout post visant une personne ou un groupe
                sur la base de la race, l’origine éthique, le genre, la
                religion, l’orientation sexuelle, ou le handicap.
              </label>
              <label htmlFor="box">
                <Checkbox name="tos" />
                <input ref={ref} id="box" type="hidden" />
                Les comportements inutiles. Tout post étant inutilement inamical
                ou hostile envers les autres membres de la communauté DEAR ou un
                groupe de notre communauté.
              </label>
              <label htmlFor="box">
                <Checkbox name="tos" />
                <input ref={ref} id="box" type="hidden" />
                Mauvais comportements sexuels. N’est pas autorisé la demande ou
                le partage de contact non sollicités. Le harcèlement sexuel,
                demande agressive de rencontres. Supplier quelqu’un de répondre
                à une demande, spammer les membres dans l’espoir de trouver des
                rencards.
              </label>
              <label htmlFor="box">
                <Checkbox name="tos" />
              ...
              <label htmlFor="box">
                <Checkbox name="tos" />
                <input ref={ref} id="box" type="hidden" />
                Toutes photos postées montrant des parties génitales, du sperme,
                des sécrétions vaginales, de l’urine et des excréments sont
